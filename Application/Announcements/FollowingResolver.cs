...
{
    public class FollowingResolver : IValueResolver<UserAnnouncement, AttendeeDTO, bool>
    {
        ...
        public bool Resolve(UserAnnouncement source, AttendeeDTO destination, bool destMember, ResolutionContext context)
        {
